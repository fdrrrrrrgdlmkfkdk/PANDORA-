...
try:
    ...
    if e == True:
        print('Модули не найденны, введите команду "pip install -r requirements.txt"')
import time
import os
...
{red}
                ...
                ░░         ░   ▒      ░   ░ ░  ░ ░  ░ ░ ░ ░ ▒    ░░   ░   ░   ▒   
                 ░              ░  ░         ░    ░        ░ ░     ░           ░  ░                       
                                ...
                                \033[1;33m       PIXEL 
                                \033[1;33m  ВНИМАНИЕ!!! ТОЛЬКО ДЛЯ ОЗНАКОМИТЕЛЬНЫХ ЦЕЛЕЙ !!!!                                        
                                \033[1;33m  СОЗДАТЕЛЬ НЕ НЕСЁТ ОТВЕТСТВЕНОСТЬ ЗА ИСПОЛЬЗОВАНИЕ ПРОГРАММЫ !!!!

                                \033[1;33m РЕКОМЕНДАЦИЯ: ИСПОЛЬЗОВАТЬ VPN ПРИ РАБОТЕ С ПРОГРАММОЙ !!!
""")
time.sleep(0.5)
popi()
time.sleep(0.5)
